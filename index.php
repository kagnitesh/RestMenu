...
<head>
    ...
    <style>
        ...
        .meal-header { width: 100%; text-align: center; font-size: 20px; font-weight: 700; margin: 0 0 12px 0; color:#111; letter-spacing: 0.5px; }
...
<body>
    <div class="container">
        ...
        <?php if ($mealType !== ''): ?>
            <div class="meal-header"><?php echo htmlspecialchars($mealType, ENT_QUOTES, 'UTF-8'); ?></div>
        <?php endif; ?>
        <div class="menu">
